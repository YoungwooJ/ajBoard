        ...
        <form method="post" action="${pageContext.request.contextPath}/member/loginMember">
            <table class="table table-bordered w-auto">
                <tr>
                    <td>아이디</td>
                    <td>
                        <input class="box form-control" type="text" name="id" value="">
                    </td>
                </tr>
                <tr>
                    <td>비밀번호</td>
            ...
            <a class="btn btn-info" type="button" href="${pageContext.request.contextPath}/member/addMember">회원가입</a>
            <a class="btn btn-success" type="button" href="${pageContext.request.contextPath}/member/findMemberIdPw">ID/PW 찾기</a>
        </form>
    </div>
</body>
</html>